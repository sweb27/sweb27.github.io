...
$(function() {
	...
	$('.logo-litera').each(function() {
		var ths = $(this);
		ths.html(ths.html().replace('Д', '<span class="uk-text-danger">Д</span>'));
		ths.html(ths.html().replace('В', '<span class="uk-text-danger">В</span>'));
	});
...
//Аякс отправка форм
	...
	$(".form-1").submit(function() {
		$.ajax({
			type: "POST",
			url: "http://test-git.dvgid.ru/mail.php",
			data: $(this).serialize()
		}).done(function() {
